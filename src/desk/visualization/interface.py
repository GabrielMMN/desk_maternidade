...
class ModelInspector:
    ...
    def extract_structure(model) -> Dict[str, Any]:
        ...
        # =====================================================================
        # ADICIONADO - Identifica fluxos alternativos e os conecta corretamente
        # =====================================================================
        for name, block in model.blocks.items():
            if hasattr(block, 'next_block_rn') and block.next_block_rn:
                structure['connections'].append((name, block.next_block_rn.name)) # tinha faltado .name
